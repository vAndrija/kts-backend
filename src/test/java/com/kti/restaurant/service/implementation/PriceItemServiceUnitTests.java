...
public class PriceItemServiceUnitTests {
    ...
    public void create_ValidPriceItem_ReturnsCreatedPriceItem() throws Exception {
        when(priceItemRepository.findPriceItemForDate(any(), anyInt())).thenReturn(new PriceItem());

        PriceItem priceItem = new PriceItem(Double.valueOf(300), null, null,
                new MenuItem(), true, Double.valueOf(200));
    ...
    public void update_ValidPriceItem_ReturnsUpdatedPriceItem() throws Exception {
        PriceItem priceItemForUpdate = new PriceItem(Double.valueOf(300), LocalDate.parse("2021-08-15"), null,
                null, false, 1, Double.valueOf(200));

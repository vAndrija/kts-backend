...
public class RestaurantTableControllerIntegrationTests {
    ...
    public void createRestaurantTable_ValidInput_ReturnsOk() throws Exception {
        ...
        RestaurantTable tableToAdd = new RestaurantTable(false, 1, 1, 500, 500);
    ...
    @ParameterizedTest
    @MethodSource("provideInvalidParametersRestaurantTable")
    ...
    private static Stream<Arguments> provideInvalidParametersRestaurantTable() {
    ...
    @Test
    public void deleteRestaurantTable_InvalidId_ReturnsNotFound() {
        int size = tableService.findAll().size();

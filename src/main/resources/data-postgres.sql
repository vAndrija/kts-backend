...
INSERT INTO users (email_address, name, last_name, password, phone_number, account_number,enabled) values
    ('prva@prva','mirko','miric', '$2a$04$Vbug2lwwJGrvUXTj6z7ff.97IzVBkrJ1XfApfGNl.Z695zqcnPYra','225883','2131231231231',true);
